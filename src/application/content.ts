...
export const applicationContent: Record<Locale, Copy> = {
  en: {
    ...
    submit: "Check application", submitting: "Checking…", invalid: "Please correct the highlighted fields.", success: "Thank you. Your application has been sent successfully.", failure: "We couldn't send your application. Please try again.",
  ...
  bm: {
    ...
    submit: "Semak permohonan", submitting: "Sedang menyemak…", invalid: "Sila betulkan medan yang ditandakan.", success: "Terima kasih. Permohonan anda telah berjaya dihantar.", failure: "Kami tidak dapat menghantar permohonan anda. Sila cuba lagi.",
  ...
  zh: {
    ...
    submit: "检查申请", submitting: "检查中…", invalid: "请更正标示的字段。", success: "谢谢。你的申请已成功发送。", failure: "无法发送你的申请。请再试一次。",
